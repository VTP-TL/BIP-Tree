...
def evaluate(model, loader_test, KSTEPS=10):
    model.eval()
    raw_data_dict = {}
    ade_bigls = []
    fde_bigls = []
    ...
    for batch in loader_test:
        ...
        loss_mask, V_obs, V_tr, category = batch
        ...
        V_pred = model(V_obs, identity, obs_traj, category)  # A_obs <8, #, #>
...
def main():
    ...
    for feta in range(len(paths)):
        ...
        for exp_path in exps:
            ...
            fd_ = 999999
            print("Testing ....")
            ade_,fde_,raw_data_dict = evaluate(model, loader_test)
