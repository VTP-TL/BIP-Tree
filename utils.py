...
class TrajectoryDataset(Dataset):
    ...
    def __init__(
        ...
        for path in all_files:
            ...
            for idx in range(0, num_sequences * self.skip + 1, skip):
                ...
                for _, ped_id in enumerate(peds_in_curr_seq):
                    ...
                    cate.append(curr_seq_data[curr_seq_data[:, 1] == ped_id, 4][0])
                ...
                if num_peds_considered > min_ped:
                    ...
                    cate = np.array(cate)
                    category.append(cate[:num_peds_considered])

        self.num_seq = len(seq_list)
        category = np.concatenate(category, axis=0)
        ...
        self.catery = torch.from_numpy(category).type(torch.float)
    ...
    def __getitem__(self, index):
        ...
        out = [
            ...
            self.v_obs[index], self.v_pred[index], self.catery[start:end]
        ]
        return out
